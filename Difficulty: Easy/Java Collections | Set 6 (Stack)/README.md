<h2><a href="https://www.geeksforgeeks.org/problems/java-collections-set-1-stack5707/1?page=9&category=Java&sortBy=submissions">Java Collections | Set 6 (Stack)</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Java provides an inbuilt object type called&nbsp;<strong>Stack</strong>. It is a collection that is based on the last in first out (LIFO) principle. Try this problem using Stack.&nbsp;</span></p>
