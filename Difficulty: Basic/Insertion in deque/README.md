<h2><a href="https://www.geeksforgeeks.org/problems/insertion-in-deque--141904/1?page=10&category=Java&sortBy=submissions">Insertion in deque</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[] </strong>containing non-negative integers. You need to insert all elements of the array to deque and return it.</span></p>
